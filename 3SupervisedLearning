...
- [Supervised learning](#supervised-learning)
  ...
  - [Classification algorithms](#classification-algorithms)
    - [Spam Recognition](#spam-recognition)
...
Training data needs to be balanced and cleaned. Garbarge, duplicate og irrelevant columns will skew the results, and therefore the algorithms will be less accurate. This means that the AI's understanding of the pattern will be greatly limited or just plain wrong.

### Data amount and spread

With lower amounts of data you will not give the algorithms enough time to understand the pattern behind why the labels are like they are. With a smaller spread you will have problems with the algorithms being very narrow in the range it can predict or categorize, meaning it would be extremely bad at handling unknown data because it is far to tuned for the data you trained it on

### Accuracy

Making the AI too accurate on the data will also make it biased towards that data. Just like the case above.

### Usecase

This one isn't as much a limitation, it's more of a pitfall users can fall into without being none the wiser. That is the pitfall of choosing a bad supervised learning algorithm for your specific case.

Deep learning algorithms can become insanely accurace without hitting the limitations above, the problem is that it takes more resources than most cases need. As well as the fact that most people don't need such an accurate model, especially if it takes a while to train to get that amount of accuracy. Therefore it's a good idea to consider what algorithms to use and keeping in mind what your usecase is. Don't go for a top of the line algorithm just because the results are good, think about what you need the model for.
